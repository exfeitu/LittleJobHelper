...
- **横向时间轴**：多天连续显示，滚轮缩放（1 小时 ~ 33 天），光标中心缩放，日分隔线，"今天"一键定位；任务轨道固定在主轴上方，工作记录摘要卡固定在主轴下方
- **稳定优先级时间轨道**：待办固定分为高/中/低三条轨道；1–2 天近景按 2 小时、3–10 天按天、远景按周聚合，同一时间桶只显示一个短标签，点击可展开具体任务
